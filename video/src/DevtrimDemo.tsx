...
const Line: React.FC<{
  ...
  const show = frame >= at;
  if (!show) return null;
  return <div style={{ whiteSpace: "pre", color: INK }}>{children}</div>;
};
  ...
  return (
    ...
    >
      ...
      <TerminalWindow title="zsh — devtrim" w={900}>
        <Line frame={frame} at={5}>
          <span style={{ color: GREEN }}>$</span> devtrim scan
        </Line>
        {[
          {
            at: 25,
          ...
          },
          {
            ...
            note: "re-downloads on demand",
          },
          {
            at: 55,
            size: "2.9 GB",
            d: 5,
            label: "stale node-modules ×6",
            note: "repos inactive ≥ 30 days",
          },
          {
            at: 70,
            size: "2.7 GB",
          ...
          <Line key={r.label} frame={frame} at={r.at}>
            <div style={{ opacity: pop(r.at) }}>
              ...
              {"  danger:"}
              <span
                style={{ color: r.d >= 7 ? RED : r.d >= 5 ? AMBER : GREEN }}
              >
                {r.d}
              </span>
              {"  "}
        ...
        <Line frame={frame} at={100}>
          <span style={{ color: GREEN }}>$</span> devtrim clean caches --apply
          -y
        </Line>
        <Line frame={frame} at={115}>
          <span style={{ color: GREEN }}>
            ✓ trashed huggingface model cache — recoverable from Finder
          </span>
        </Line>
      ...
      >
        {[
          ...
          <div
            key={b.t}
            style={{
              opacity: pop(130 + i * 12),
              transform: `translateY(${(1 - pop(130 + i * 12)) * 14}px)`,
            }}
          >
            <div
              style={{
            ...
            <div
              style={{ fontSize: 22, color: MUTED, fontFamily: "monospace" }}
            >
              {b.s}
            </div>
          </div>
      ...
      >
        ...
        <div style={{ fontFamily: "monospace", fontSize: 30, color: MUTED }}>
